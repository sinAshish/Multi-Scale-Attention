...
class DAF_stack(nn.Module):
    ...
    def forward(self, x):
        ...
        refine4=self.conv8_2(refine4_1+refine4_2)
        ...
        refine3=self.conv8_2(refine3_1+refine3_2)
        ...
        refine2=self.conv8_2(refine2_1+refine2_2)
        ...
        refine1=self.conv8_2(refine1_1+refine1_2)
